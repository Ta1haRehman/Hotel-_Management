    ...
    <div class="container form-container">
        ...
        <div class="form-card p-0 form-animation">
            <div class="form-header">
                ...
                <p class="form-subtitle">Register a new guest to the hotel system</p>
            </div>
            ...
            <div class="p-4">
                <form method="POST">
                    <div class="form-group">
                        ...
                        <div class="position-relative">
                            <input type="text" name="name" class="form-control" required placeholder="Enter guest's full name">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $query = "INSERT INTO Guest (name, phone, email) VALUES ('$name', '$phone', '$email')";
